...
var _book = require("./model/book.model");
...
var main = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var PORT, app, schema, schemaWithResolvers, pubsub, server;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _load.loadSchema)((0, _path.join)(__dirname, "/graphql/schema/schema.graphql"), {
              loaders: [new _graphqlFileLoader.GraphQLFileLoader()]
            });

          case 4:
            schema = _context.sent;
            schemaWithResolvers = (0, _schema.addResolversToSchema)({
              schema: schema,
              resolvers: _resolvers.resolvers
            });
            pubsub = (0, _node.createPubSub)();
            server = (0, _node.createServer)({
              // endpoint: "/api",
              // port: 9090,
            ...
            app.get("/", function (_, res) {
              return res.send({
                message: "Graphql Yoga Server running on /graphql API"
              });
            });
